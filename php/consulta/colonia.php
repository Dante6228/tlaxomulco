...
if (isset($_POST['nivelEducativoId'], $_POST['gradoId'], $_POST['cicloId'], $_POST['coloniaId'])) {
    
    $nivelEducativoId = $_POST['nivelEducativoId'];
    $gradoId = $_POST['gradoId'];
    $cicloId = $_POST['cicloId'];
    $coloniaId = $_POST['coloniaId'];
    ...
    $stmt->execute([$nivelEducativoId, $gradoId, $cicloId, $coloniaId]);
