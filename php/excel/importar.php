...
if ($data) {
    ...
    for ($i = 1; $i < count($data); $i++) {
        ...
        echo "<br><strong>Datos nivel, grado y ciclo extraidos correctamete</strong><br><br>";
        ...
        echo "<br><strong>Datos genero, municipio, colonia, estado, medio enterado y promoción extraidos correctamete</strong><br><br>";
