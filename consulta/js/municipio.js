...
async function mostrarAlumnos() {
    ...
    if (nivelEducativoId && gradoId && cicloId && municipioId) {
        ...
        Swal.fire({
            title: 'Faltan datos',
            text: 'Por favor, selecciona un nivel educativo, grado, ciclo escolar y municipio.',
            icon: 'warning',
...
async function generarExcel() {
    ...
    try {
        ...
        a.style.display = 'none';
        a.href = url;
        a.download = 'Listado_de_Alumnos_Por_Municipio.xlsx';
        document.body.appendChild(a);
        a.click();
        window.URL.revokeObjectURL(url);

        window.location.href = '/tlaxomulco/consulta/municipio.php?mensaje=excel';
