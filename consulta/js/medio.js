...
async function mostrarAlumnos() {
    ...
    if (nivelEducativoId && gradoId && cicloId && medioId) {
        ...
        Swal.fire({
            title: 'Faltan datos',
            text: 'Por favor, selecciona un nivel educativo, grado, ciclo escolar y medio.',
            icon: 'warning',
...
async function generarPDF() {
    ...
    try {
        ...
        a.download = `Listado_de_alumnos_por_medio_de_enterado_${cicloTexto}.pdf`;
...
async function generarExcel() {
    ...
    try {
        ...
        a.style.display = 'none';
        a.href = url;
        a.download = 'Listado_de_Alumnos_Por_Medio.xlsx';
        document.body.appendChild(a);
        a.click();
        window.URL.revokeObjectURL(url);

        window.location.href = '/tlaxomulco/consulta/medio.php?mensaje=excel';
